        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NavigationsItems = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibraryCardLines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LibraryCardLines_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LibraryCardLines_LibraryCards_CardId",
                        column: x => x.CardId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LibraryCardLines_BookId",
                table: "LibraryCardLines",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_LibraryCardLines_CardId",
                table: "LibraryCardLines",
                column: "CardId");
